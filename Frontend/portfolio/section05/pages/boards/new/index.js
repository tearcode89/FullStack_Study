import {Address,ButtonWrapper,Contents,Wrapper,Writer,Youtube,InputWrapper,OptionWrapper,ImageWrapper
,Label,Password,RadioLabel,RadioButton,SubmitButton,SearchButton,UploadButton,
Subject,Title,Zipcode,ZipcodeWrapper,WriterWrapper,Error} from "../../../styles/boardsNew";
    ...
    return(
        <Wrapper>
            ...
            <OptionWrapper>
                ...
                <RadioLabel htmlFor="imaage">사진</RadioLabel>
            </OptionWrapper>
            <ButtonWrapper>
